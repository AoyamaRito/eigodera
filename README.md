...
スパイ映画の世界観で英語を学ぶAI英会話プラットフォームです。あなたは秘密エージェントとして、様々なミッションを通じて英語スキルを磨き上げます。

## 🎯 ミッション概要

国際的なエージェントとして活動するために必要な英語力を身につけましょう。AIが生成するリアルなスパイシナリオの中で、実践的な英会話スキルを習得できます。

## 🛠️ エージェント装備（主な機能）

- **エージェント認証システム** - Supabase Authによる秘密エージェント登録・認証
- **ミッション管理** - Stripeによる月額エージェント訓練プログラム
- **AI司令官** - OpenAI APIを使用したスパイミッション・シナリオ生成
- **ビジュアル情報収集** - Luma AI (Photon-1モデル)による任務関連画像生成
- **多言語対応作戦** - 英語圏での潜入任務に特化した会話訓練
